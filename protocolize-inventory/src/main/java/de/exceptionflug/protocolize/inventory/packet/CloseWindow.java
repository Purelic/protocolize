...
public class CloseWindow extends AbstractPacket {
  ...
  static {
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_7_2, 0x2E);
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_7_6, 0x2E);
    ...
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_16_4, 0x12);
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_17, 0x13);
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_17_1, 0x13);

    MAPPING_SERVERBOUND.put(MINECRAFT_1_7_2, 0x0D);
    MAPPING_SERVERBOUND.put(MINECRAFT_1_7_6, 0x0D);
    ...
    MAPPING_SERVERBOUND.put(MINECRAFT_1_17_1, 0x09);
  }
