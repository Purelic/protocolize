...
public class HeldItemChange extends AbstractPacket {
  ...
  static {
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_7_2, 0x09);
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_7_6, 0x09);
    ...
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_17, 0x48);
    MAPPING_CLIENTBOUND.put(MINECRAFT_1_17_1, 0x48);

    MAPPING_SERVERBOUND.put(MINECRAFT_1_7_2, 0x09);
    MAPPING_SERVERBOUND.put(MINECRAFT_1_7_6, 0x09);
    ...
    MAPPING_SERVERBOUND.put(MINECRAFT_1_17, 0x25);
    MAPPING_SERVERBOUND.put(MINECRAFT_1_17_1, 0x25);
  }
