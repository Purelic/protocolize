...
public class PlayerPosition extends AbstractPacket {
  ...
  static {
    ...
    MAPPING.put(MINECRAFT_1_14_4, 0x11);
    MAPPING.put(MINECRAFT_1_15, 0x11);
    ...
    MAPPING.put(MINECRAFT_1_16_2, 0x12);
    MAPPING.put(MINECRAFT_1_16_3, 0x12);
    MAPPING.put(MINECRAFT_1_16_4, 0x12);
    MAPPING.put(MINECRAFT_1_17, 0x11);
    MAPPING.put(MINECRAFT_1_17_1, 0x11);
  }
